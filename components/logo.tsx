...
export function Logo({
  ...
  const logoContent = (
    <div className={cn("group flex items-center", currentSize.container, className)}>
      ...
      <div
        className={cn(
          "relative grid place-items-center rounded-lg border border-primary/20 bg-gradient-to-br from-primary/5 to-primary/5 backdrop-blur-sm transition-colors duration-200 group-hover:border-primary/30",
      ...
      >
        ...
        />
        {/* subtle accent glow */}
        <span className="pointer-events-none absolute inset-0 -z-10 rounded-lg bg-gradient-to-br from-primary/10 to-transparent opacity-0 transition-opacity duration-200 group-hover:opacity-100" />
      </div>
